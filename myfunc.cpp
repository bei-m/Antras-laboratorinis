...
void studentas::spausdinti()
{
    ...
    cout<<left<<setw(19)<<Pavarde<<left<<setw(16)<<Vardas;
    cout<<"    "<<setw(14)<<fixed<<setprecision(2)<<gvidurkis<<"    "<<setw(14)<<fixed<<setprecision(2)<<gmediana<<endl;
...
template <typename T> void isvedimas( T&grupe_1, T&grupe_2, bool st)
{
    ...
    for (auto &j:grupe_1)
    { rez1<<setw(20)<<left<<j.getpavarde()<<setw(16)<<left<<j.getvardas()<<setw(16)<<fixed<<setprecision(2)<<j.getvid()<<setw(16)<<fixed<<setprecision(2)<<j.getmed()<<endl;}
    grupe_1.clear(); 

    ofstream rez2(v);
    rez2<<setw(20)<<left<<"Pavarde"<<setw(16)<<left<<"Vardas"<<setw(16)<<left<<"Galutinis(Vid.)"<<setw(16)<<left<<"Galutinis(Med.)"<<endl;
    for (auto &j:grupe_2)
    { rez2<<setw(20)<<left<<j.getpavarde()<<setw(16)<<left<<j.getvardas()<<setw(16)<<fixed<<setprecision(2)<<j.getvid()<<setw(16)<<fixed<<setprecision(2)<<j.getmed()<<endl;}
    grupe_2.clear(); 
}